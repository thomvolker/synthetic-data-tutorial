...
To be a bit more precise, this means that both univariate and multivariate patterns of the observed data are preserved in the synthetic data, such as the mean and variance for each variables and the covariances between variables.
Moreover, if we model $f(X)$ accurately and draw new samples from this model, the introduced noise adds uncertainty that provides privacy protection.
...
* Synthetic data can help to protect privacy of respondents.
