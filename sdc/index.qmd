...
The first step in the process of releasing data is to anonymize it (see for instance our [Data Anonymization tutorial](https://lmu-osc.github.io/data-anonymization/)). 
