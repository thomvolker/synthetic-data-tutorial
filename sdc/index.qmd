...
Common methods that have traditionally been used for statistical disclosure control are: 
...
The idea of synthetic data will be more thorougly explained in [the subsequent section](../generation/).
